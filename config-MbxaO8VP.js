...
import { t as gubaksa_default } from "./data-samples-BYFtYlxU.js";
...
var MANIFEST = {
	...
	data: {
		...
		/** 샘플 파티 (구박사의 포켓몬 챔피언스 연구소 영상에서 옮김). 새 영상 반영 = 이 파일만 고치면 data-samples 조각만 바뀜 */
		curated: [gubaksa_default],
		/** 상대 AI 가 샘플 파티를 들고 나올 확률 (나머지는 랜덤 세트 파티) */
		curatedOpponentRate: .4
	},
	/** 외부 리소스 */
...
var CHANGELOG = [
	{
		...
		notes: [
			"대타출동 인형 표시",
			"배틀 연출: 기술(물리 돌진·특수 구슬·변화 고리)·피격(상성별 흔들림·급소 번쩍)·능력 변화 화살표·상태이상·회복·메가진화·방어·날씨/필드 (설정에서 켜기/움직임 줄이기/끄기)",
			"정보창에 능력 변화(공↑2 등) 표시",
			"잘리는 글: 한 줄은 좌우로 밀어 보기, 기술 설명은 눌러서 펼치기",
			"구박사의 포켓몬 챔피언스 연구소 샘플 파티 6개(36세트): 샘플 세트·파티 불러오기·상대 파티(40%)"
		]
	},
	{
		version: "1.4.1",
