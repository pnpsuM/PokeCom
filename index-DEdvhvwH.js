...
import { a as GRADES, i as PROFILES, n as CHANGELOG, o as RATING_POLICY, s as MANIFEST, t as APP_VERSION } from "./config-DXEndUyi.js";
import { A as koItemDesc, B as toID, C as euro, D as koAbilityDesc, E as koAbility, F as koType, I as matchKo, L as BattleStream, M as koMoveDesc, N as koNature, O as koEffect, P as koSpecies, R as Teams, S as eun, T as josa, _ as CATEGORY_KO, a as exportTeam, b as STAT_SHORT, c as sampleSets, d as validateTeam, f as FORMAT, g as isPickable, h as dex, i as blankSet, j as koMove, k as koItem, l as statTotal, m as calcStat, n as RandomTeamSource, o as importTeam, p as STATS, r as SPARE_ITEMS, s as koProblem, t as makeAgent, u as validateSet, v as STATUS_KO, w as iga, x as eul, y as STAT_KO, z as getPlayerStreams } from "./ai-DLaof3do.js";
...
function effectiveness(move, targetSpecies, typeOverride) {
...
function resolveMoveType(battle, pokemon, target, moveId, abilityOverride) {
	...
	if (base.category === "Status") return out;
...
var BattleController = class {
	...
	showCommands(req) {
		...
		const moves = h("div", { class: "moves" }, act.moves.map((m, i) => {
			...
			const note = ti && ti.type !== ti.baseType ? typeNote(ti) : "";
			const eff = foe ? effectiveness(m.id, foe, type) : null;
			...
			}, h("b", null, koMove(m.move)), h("small", null, `${koType(type)}${note ? "*" : ""} · ${m.maxpp ? `${m.pp}/${m.maxpp}` : "-"}`, eff == null ? null : h("span", { class: `eff ${badgeFor(eff).cls}` }, badgeFor(eff).label)));
			b.style.flex = "1";
